...
var t, e, i, s, n = {
    640: (t,e,i)=>{
        ...
        class PopupElement {
            ...
            constructor({container: t, color: e, elements: i, titleObj: s, modificationDate: a, contentsObj: r, richText: o, parent: l, rect: h, parentRect: d, open: c}) {
                ...
                for (const t of i)
                    t.container?.addEventListener("keydown", this.#n);
                this.#p.hidden = !0;
                c && this.#c()
            }
            render() {
                if (this.#y)
                    return;
                const {page: {view: t}, viewport: {rawDims: {pageWidth: e, pageHeight: i, pageX: n, pageY: a}}} = this.#b
            ...
            #h() {
                this.#y || this.render();
                if (this.isVisible)
                    this.#v && this.#p.classList.add("focused");
                else {
                    this.#p.hidden = !1;
        ...
        class LineAnnotationElement extends AnnotationElement {
            ...
            render() {
                ...
                const t = this.data
                  ...
                  , n = this.#C = this.svgFactory.createElement("svg:line");
        ...
        i.a(t, (async(t,s)=>{
            try {
                ...
                const y = 65536
                  , E = 100
                  , _ = 5e3
                  , w = n.isNodeJS ? l.NodeCanvasFactory : r.DOMCanvasFactory
                  , x = n.isNodeJS ? l.NodeCMapReaderFactory : r.DOMCMapReaderFactory
                  , C = n.isNodeJS ? l.NodeFilterFactory : r.DOMFilterFactory
                  , S = n.isNodeJS ? l.NodeStandardFontDataFactory : r.DOMStandardFontDataFactory;
                function getDocument(t) {
                    ...
                    r.isDataScheme)(t.docBaseUrl) ? null : t.docBaseUrl
                      , _ = "string" == typeof t.cMapUrl ? t.cMapUrl : null
                      , T = !1 !== t.cMapPacked
                      , M = t.CMapReaderFactory || x
                      , P = "string" == typeof t.standardFontDataUrl ? t.standardFontDataUrl : null
                      , F = t.StandardFontDataFactory || S
                      , R = !0 !== t.stopAtErrors
                      ...
                      , G = "boolean" == typeof t.useWorkerFetch ? t.useWorkerFetch : M === r.DOMCMapReaderFactory && F === r.DOMStandardFontDataFactory && _ && P && (0,
                    r.isValidFetchUrl)(_, document.baseURI) && (0,
                    r.isValidFetchUrl)(P, document.baseURI)
                      , $ = t.canvasFactory || new w({
                        ownerDocument: U
                    })
                    ...
                    A.promise.then((function() {
                        ...
                        const t = _fetchDocument(A, Y)
                          , h = new Promise((function(t) {
                            ...
                            if (u)
                                ...
                                e = (t=>n.isNodeJS ? new b.PDFNodeStream(t) : (0,
                                r.isValidFetchUrl)(t.url) ? new m.PDFFetchStream(t) : new f.PDFNetworkStream(t))({
                                    url: s,
                                    length: W,
                                    httpHeaders: o,
                                    withCredentials: l,
                        ...
                        return Promise.all([t, h]).then((function([t,s]) {
                            ...
                            const n = new c.MessageHandler(i,t,A.port)
                              , a = new WorkerTransport(n,e,s,J,X);
                            e._transport = a;
                            n.send("Ready", null)
                        }
                        ))
                ...
                function getUrlProp(t) {
                    ...
                    try {
                        ...
                        if (n.isNodeJS && "string" == typeof t)
                            return t
                    }
                    throw new Error("Invalid PDF url data: either string or URL-object is expected in the url property.")
                }
                function getDataProp(t) {
                    if (n.isNodeJS && "undefined" != typeof Buffer && t instanceof Buffer)
                ...
                class PDFDataRangeTransport {
                    ...
                    requestDataRange(t, e) {
                        (0,
                        n.unreachable)("Abstract method PDFDataRangeTransport.requestDataRange")
                    }
                    abort() {}
                }
                class PDFDocumentProxy {
                    ...
                    get isPureXfa() {
                        return (0,
                        n.shadow)(this, "isPureXfa", !!this._transport._htmlForXfa)
                    }
                    get allXfaHtml() {
                ...
                class PDFWorker {
                    ...
                    _initialize() {
                        if (!T.isWorkerDisabled && !PDFWorker.#X) {
                            ...
                            try {
                                ...
                                (0,
                                n.info)("The worker has been disabled.")
                            }
                        }
                        this._setupFakeWorker()
                    }
                    ...
                    static get _setupFakeWorkerGlobal() {
                        return (0,
                        n.shadow)(this, "_setupFakeWorkerGlobal", (async()=>{
                            if (this.#X)
                                return this.#X;
                ...
                class WorkerTransport {
                    ...
                    get annotationStorage() {
                        return (0,
                        n.shadow)(this, "annotationStorage", new a.AnnotationStorage)
                    }
                    getRenderingIntent(t, e=n.AnnotationMode.ENABLE, i=null, s=!1) {
                        ...
                        default:
                            (0,
                            n.warn)(`getRenderingIntent - invalid intent: ${t}`)
                        }
                        switch (e) {
                        ...
                        default:
                            (0,
                            n.warn)(`getRenderingIntent - invalid annotationMode: ${e}`)
                        }
                    ...
                    setupMessageHandler() {
                        ...
                        t.on("GetReader", ((t,e)=>{
                            (0,
                            n.assert)(this._networkStream, "GetReader - no `IPDFStream` instance available.");
                            ...
                            e.onPull = ()=>{
                                this._fullReader.read().then((function({value: t, done: i}) {
                                    if (i)
                                        ...
                                        (0,
                                        n.assert)(t instanceof ArrayBuffer, "GetReader - expected an ArrayBuffer.");
                        ...
                        t.on("GetRangeReader", ((t,e)=>{
                            (0,
                            n.assert)(this._networkStream, "GetRangeReader - no `IPDFStream` instance available.");
                                ...
                                e.onPull = ()=>{
                                    i.read().then((function({value: t, done: i}) {
                                        if (i)
                                            ...
                                            (0,
                                            n.assert)(t instanceof ArrayBuffer, "GetRangeReader - expected an ArrayBuffer.");
                                            e.enqueue(new Uint8Array(t), 1, [t])
                                        }
                                    }
                                    )).catch((t=>{
                        ...
                        t.on("commonobj", (([e,i,s])=>{
                            ...
                            case "Font":
                                ...
                                if ("error"in s) {
                                    const t = s.error;
                                    (0,
                                    n.warn)(`Error during font loading: ${t}`);
                                    this.commonObjs.resolve(e, t);
                                    break
                                }
                                const r = a.pdfBug && globalThis.FontInspector?.enabled ? (t,e)=>globalThis.FontInspector.fontAdded(t, e) : null
                            ...
                            case "CopyLocalImage":
                                const {imageRef: h} = s;
                                (0,
                                n.assert)(h, "The imageRef must be defined.");
                    ...
                    saveDocument() {
                        ...
                        n.warn)("saveDocument called while `annotationStorage` is empty, please use the getData-method instead.");
    ...
    250: (t,e,i)=>{
        ...
        class RadialAxialShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, i, o) {
                let l;
                if (o === r || o === a) {
                    const a = e.current.getClippedPathBoundingBox(o, (0,
        ...
        class MeshShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, i, a) {
                ...
                let r;
                if (a === o)
                    r = s.Util.singularValueDecompose2dScale((0,
        ...
        class CanvasGraphics {
            ...
            _createMaskCanvas(t) {
                ...
                if (!u) {
                    ...
                    n.getCurrentTransformInverse)(_));
                    u = u.img;
                    d && l && d.set(c, u)
                }
                _.imageSmoothingEnabled = getImageSmoothingEnabled((0,
                n.getCurrentTransform)(_), t.interpolate);
                drawImageAtIntegerCoords(_, u, 0, 0, u.width, u.height, 0, 0, i, r);
                _.globalCompositeOperation = "source-in";
                const C = s.Util.transform((0,
                n.getCurrentTransformInverse)(_), [1, 0, 0, 1, -w, -x]);
            ...
            stroke(t=!0) {
                ...
                if (this.contentVisible)
                    if ("object" == typeof i && i?.getPattern) {
                        ...
                        n.getCurrentTransformInverse)(e), r);
            ...
            fill(t=!0) {
                ...
                if (this.current.patternFill) {
                    ...
                    n.getCurrentTransformInverse)(e), a);
                    s = !0
                }
            ...
            showText(t) {
                ...
                if (e.patternFill) {
                    ...
                    n.getCurrentTransformInverse)(o), a);
                    v = (0,
            ...
            shadingFill(t) {
                ...
                e.fillStyle = i.getPattern(e, this, (0,
                n.getCurrentTransformInverse)(e), o);
                const a = (0,
            ...
            paintImageMaskXObjectGroup(t) {
                ...
                for (const r of t) {
                    ...
                    c.fillStyle = s ? i.getPattern(c, this, (0,
                    n.getCurrentTransformInverse)(e), a) : i;
                    c.fillRect(0, 0, o, l);
                    c.restore();
                    e.save();
                    e.transform(...h);
    ...
    423: (t,e,i)=>{
        ...
        class DrawLayer {
            ...
            static get _svgFactory() {
                return (0,
                n.shadow)(this, "_svgFactory", new s.DOMSVGFactory)
            }
    ...
    629: (t,e,i)=>{
        ...
        class FreeTextEditor extends n.AnnotationEditor {
            ...
            static get _keyboardManager() {
                ...
                return (0,
                s.shadow)(this, "_keyboardManager", new a.KeyboardManager([[["ctrl+s", "mac+meta+s", "ctrl+p", "mac+meta+p"], t.commitOrRemove, {
                    bubbles: !0
            ...
            get propertiesToUpdate() {
                return [[s.AnnotationEditorParamsType.FREETEXT_SIZE, this.#It], [s.AnnotationEditorParamsType.FREETEXT_COLOR, this.#u]]
            }
            #Ot(t) {
                const setFontsize = t=>{
            ...
            getInitialTranslation() {
                ...
                return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#It) * t]
            }
            rebuild() {
                if (this.parent) {
                    super.rebuild();
            ...
            serialize(t=!1) {
                ...
                const e = FreeTextEditor._internalPadding * this.parentScale
                  , i = this.getRect(e, e)
                  , a = n.AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#u)
                  , r = {
                    annotationType: s.AnnotationEditorType.FREETEXT,
                    color: a,
                    fontSize: this.#It,
                ...
                if (t)
                    return r;
                if (this.annotationElementId && !this.#jt(r))
                    return null;
        ...
        class HighlightEditor extends n.AnnotationEditor {
            ...
            #Qt() {
                ...
                this.#Xt = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height]
            }
            static initialize(t) {
                n.AnnotationEditor.initialize(t)
            }
            static updateDefaultParams(t, e) {
                if (t === s.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR)
            ...
            updateParams(t, e) {
                if (t === s.AnnotationEditorParamsType.HIGHLIGHT_COLOR)
                    this.#Bt(e)
            }
            static get defaultPropertiesToUpdate() {
                return [[s.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor]]
            }
            get propertiesToUpdate() {
                return [[s.AnnotationEditorParamsType.HIGHLIGHT_COLOR, this.color || HighlightEditor._defaultColor]]
            }
            #Bt(t) {
                const e = this.color;
                this.addCommands({
            ...
            render() {
                if (this.div)
                    return this.div;
                const t = super.render()
                  , e = this.#$t = document.createElement("div");
                t.append(e);
                ...
                (0,
                a.bindEvents)(this, this.#$t, ["pointerover", "pointerleave"]);
                this.enableEditing();
                return t
            }
            pointerover() {
            ...
            serialize(t=!1) {
                ...
                const e = this.getRect(0, 0)
                  , i = n.AnnotationEditor._colorManager.convert(this.color);
                return {
        ...
        class InkEditor extends n.AnnotationEditor {
            #ne = 0;
            #ae = 0;
            #re = this.canvasPointermove.bind(this);
            #oe = this.canvasPointerleave.bind(this);
            #le = this.canvasPointerup.bind(this);
            #he = this.canvasPointerdown.bind(this);
            #de = null;
            #ce = new Path2D;
            #ue = !1;
            #pe = !1;
            ...
            #Ee(t=!1) {
                ...
                const s = Math.ceil(i + this.#ae * this.scaleFactor)
                  , a = Math.ceil(i + this.#ne * this.scaleFactor)
            ...
            static deserialize(t, e, i) {
                if (t instanceof r.InkAnnotationElement)
                    return null;
                const a = super.deserialize(t, e, i);
        ...
        class StampEditor extends n.AnnotationEditor {
            ...
            #si(t, e) {
                ...
                i.width = t;
                i.height = e;
                const s = this.#Qe ? this.#We : this.#ai(t, e)
                  , n = i.getContext("2d");
        ...
        class AnnotationEditorLayer {
            ...
            #oi = !1;
            #li = null;
            #hi = this.pointerup.bind(this);
            #di = this.pointerUpAfterSelection.bind(this);
            #ci = this.pointerdown.bind(this);
            #ui = null;
            #pi = this.selectionStart.bind(this);
            #gi = new Map;
            #mi = !1;
            #fi = !1;
            #bi = !1;
            ...
            static #yi = new Map([FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map((t=>[t._editorType, t])));
            constructor({uiManager: t, pageIndex: e, div: i, accessibilityManager: s, annotationLayer: n, drawLayer: a, textLayer: r, viewport: o, l10n: l}) {
                const h = [...AnnotationEditorLayer.#yi.values()];
            ...
            updateMode(t=this.#vi.getMode()) {
                ...
                if (t !== s.AnnotationEditorType.NONE) {
                    ...
                    for (const i of AnnotationEditorLayer.#yi.values())
                        e.toggle(`${i._type}Editing`, t === i._editorType);
                    this.div.hidden = !1
                }
            }
            addInkEditorIfNeeded(t) {
                if (this.#vi.getMode() !== s.AnnotationEditorType.INK)
                    return;
                if (!t)
            ...
            enable() {
                ...
                for (const i of e) {
                    i.hide();
                    if (this.#vi.isDeletedAnnotationElement(i.data.id))
                        continue;
                    if (t.has(i.data.id))
                        continue;
            ...
            disable() {
                ...
                const {classList: e} = this.div;
                for (const t of AnnotationEditorLayer.#yi.values())
            ...
            pasteEditor(t, e) {
                ...
                const {offsetX: i, offsetY: s} = this.#Ci()
                  , n = this.getNextId()
                  , a = this.#xi({
                    parent: this,
                    id: n,
            ...
            pointerUpAfterSelection(t) {
                ...
                if (i.collapsed)
                    return;
                if (!this.#Ai?.div.contains(i.commonAncestorContainer))
                    return;
                const {x: s, y: n, width: a, height: r} = this.#Ai.div.getBoundingClientRect()
                  , o = i.getClientRects();
                let l;
                ...
                const h = [];
                for (const {x: t, y: e, width: i, height: s} of o)
                    0 !== i && 0 !== s && h.push(l(t, e, i, s));
            ...
            render({viewport: t}) {
                this.viewport = t;
                (0,
                h.setLayerDimensions)(this.div, t);
                for (const t of this.#vi.getEditors(this.pageIndex))
                    this.add(t);
                this.updateMode()
            }
            update({viewport: t}) {
    ...
    97: (t,e,i)=>{
        ...
        class ColorPicker {
            ...
            updateColor(t) {
                ...
                for (const i of this.#Pi.children)
    ...
    115: (t,e,i)=>{
        ...
        class EditorToolbar {
            ...
            render() {
                ...
                if (i) {
                    const {style: e} = t
                      , s = "ltr" === this.#ji._uiManager.direction ? 1 - i[0] : i[0];
        ...
        class AnnotationEditor {
            ...
            #ts = null;
            #es = null;
            #is = this.focusin.bind(this);
            #ss = this.focusout.bind(this);
            #ns = null;
            #as = "";
            #rs = !1;
            #os = !1;
            ...
            static get _resizerKeyboardManager() {
                ...
                return (0,
                n.shadow)(this, "_resizerKeyboardManager", new s.KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], t, {
                    args: [-e, 0]
            ...
            #ys(t, e) {
                ...
                let E = 1
                  , _ = 1
                  , [w,x] = this.screenToPageTranslation(e.movementX, e.movementY);
                [w,x] = (C = w / i,
                S = x / s,
                [c[0] * C + c[2] * S, c[1] * C + c[3] * S]);
                var C, S;
                if (g) {
                    const t = Math.hypot(r, o);
                    E = _ = Math.max(Math.min(Math.hypot(b[0] - f[0] - w, b[1] - f[1] - x) / t, 1 / r, 1 / o), l / r, h / o)
                } else
                    m ? E = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - w))) / r : _ = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - x))) / o;
                const T = round(r * E)
                  , M = round(o * _);
                A = transf(...p(T, M));
                const P = v - A[0]
            ...
            makeResizable() {
                if (this.isResizable) {
                    ...
                    (0,
                    s.bindEvents)(this, this.div, ["keydown"])
                }
            }
            get toolbarPosition() {
                return null
            ...
            keydown(t) {
                ...
                if (n !== s) {
                    if (n < s)
                        for (let t = 0; t < s - n; t++)
                            this.#ts.append(this.#ts.firstChild);
                    else if (n > s)
                        for (let t = 0; t < n - s; t++)
                            this.#ts.firstChild.before(this.#ts.lastChild);
                    let t = 0;
                    for (const i of e) {
    ...
    812: (t,e,i)=>{
        ...
        class AnnotationEditorUIManager {
            ...
            #an = null;
            #rn = null;
            #on = s.AnnotationEditorType.NONE;
            #ln = new Set;
            #hn = null;
            #dn = this.blur.bind(this);
            #cn = this.focus.bind(this);
            #un = this.copy.bind(this);
            #pn = this.cut.bind(this);
            #gn = this.paste.bind(this);
            #mn = this.keydown.bind(this);
            #fn = this.onEditingAction.bind(this);
            #bn = this.onPageChanging.bind(this);
            #An = this.onScaleChanging.bind(this);
            #vn = this.onRotationChanging.bind(this);
            #yn = {
                isEditing: !1,
                isEmpty: !0,
            ...
            static get _keyboardManager() {
                ...
                return (0,
                s.shadow)(this, "_keyboardManager", new KeyboardManager([[["ctrl+a", "mac+meta+a"], t.selectAll, {
            ...
            get hcmFilter() {
                return (0,
                s.shadow)(this, "hcmFilter", this.#hn ? this.#Zs.addHCMFilter(this.#hn.foreground, this.#hn.background) : "none")
            }
            get direction() {
                return (0,
                s.shadow)(this, "direction", getComputedStyle(this.#p).direction)
            }
            get highlightColors() {
                return (0,
                s.shadow)(this, "highlightColors", this.#en ? new Map(this.#en.split(",").map((t=>t.split("=").map((t=>t.trim()))))) : null)
            }
            ...
            registerEditorTypes(t) {
                if (!this.#yi) {
                    this.#yi = t;
                    for (const t of this.#yi)
                        this.#Dn(t.defaultPropertiesToUpdate)
                }
            }
            getId() {
            ...
            unselectAll() {
                if (this.#Vs) {
                    this.#Vs.commitOrRemove();
                    if (this.#on !== s.AnnotationEditorType.NONE)
                        return
                }
                if (this.hasSelection) {
                    for (const t of this.#ln)
            ...
            translateSelectedEditors(t, e, i=!1) {
                ...
                this.#_n = setTimeout((()=>{
                    ...
                    this.addCommands({
                        cmd: ()=>{
                            for (const t of a)
                                this.#Ws.has(t.id) && t.translateInPage(s, n)
                        }
                        ,
                        undo: ()=>{
                            for (const t of a)
                ...
                class PDFNodeStreamFullReader extends BaseFullReader {
                    constructor(t) {
                        ...
                        const handleResponse = e=>{
                            ...
                            this._contentLength = s || this._contentLength;
                            this._filename = (0,
                            a.extractFilenameFromHeader)(getResponseHeader)
                        }
                        ;
                        this._request = null;
    ...
    890: (t,e,i)=>{
        ...
        class OptionalContentConfig {
            ...
            constructor(t) {
                ...
                if (null !== t) {
                    ...
                    for (const e of t.groups)
                        this.#jn.set(e.id, new OptionalContentGroup(e.name,e.intent));
                    if ("OFF" === t.baseState)
                        for (const t of this.#jn.values())
                            t._setVisible(a, !1);
                    for (const e of t.on)
                        this.#jn.get(e)._setVisible(a, !0);
                    for (const e of t.off)
                        this.#jn.get(e)._setVisible(a, !1);
            ...
            getOrder() {
                return this.#jn.size ? this.#Wn ? this.#Wn.slice() : [...this.#jn.keys()] : null
            }
            getGroups() {
                return this.#jn.size > 0 ? (0,
                s.objectFromMap)(this.#jn) : null
            }
            getGroup(t) {
    ...
    266: (t,e,i)=>{
        ...
        const x = [...Array(256).keys()].map((t=>t.toString(16).padStart(2, "0")));
        class Util {
...
__webpack_require__.a = (n,a,r)=>{
    ...
    a((n=>{
        ...
        var a, getResult = ()=>l.map((t=>{
            ...
            (a = ()=>e(getResult)).r = 0;
            var fnQueue = t=>t !== o && !c.has(t) && (c.add(t),
            t && !t.d && (a.r++,
            t.push(a)));
            l.map((e=>e[t](fnQueue)))
        }
...
var r = __webpack_require__(907)
  , o = (r = globalThis.pdfjsLib = await (globalThis.pdfjsLibPromise = r)).AbortException
  ...
  , b = r.DrawLayer
  , A = r.FeatureTest
  , v = r.GlobalWorkerOptions
  , y = r.ImageKind
  , E = r.InvalidPDFException
  , _ = r.MissingPDFException
  , w = r.OPS
  , x = r.Outliner
  , C = r.PDFDataRangeTransport
  , S = r.PDFDateString
  , T = r.PDFWorker
  , M = r.PasswordResponses
  , P = r.PermissionFlag
  , F = r.PixelsPerInch
  , R = r.PromiseCapability
  , k = r.RenderingCancelledException
  , D = r.UnexpectedResponseException
  , I = r.Util
  , L = r.VerbosityLevel
  , O = r.XfaLayer
  , B = r.build
  ...
  , U = r.fetchData
  , z = r.getDocument
  , H = r.getFilenameFromUrl
  , j = r.getPdfFilenameFromUrl
  , V = r.getXfaPageViewport
  , W = r.isDataScheme
  , q = r.isPdfFile
  , G = r.noContextMenu
  , $ = r.normalizeUnicode
